class Play extends Phaser.Scene {
    ...
    init() {
        // useful variables
        // treating it as a constant so capitalozong it
    ...
    create() {
        ...
        this.cup.body.setCircle(this.cup.width / 4) //access width property and divide by 4
        ...
        wallB.body.setImmovable(true) // command D to edit and highlight all the code u want
        ...
        this.input.on('pointerdown', (pointer) => { //string defined by phaser, and defined function w anon arrow function
            ...
            this.SHOT_VELOCITY_Y_MAX) * shotDirection)  // built in phaser function 
        }) 
